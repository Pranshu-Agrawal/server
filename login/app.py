...
def index():
        ...
        if request.method == 'POST' and 'movie' in request.form:
                ...
                try :
                        ...
                        return render_template('index.html', movie_names=movie_names, movie_list=li, movie=movie, rating=request.form['rating'])
                except IndexError :
                        return render_template('index.html', movie=movie, movie_names=movie_names, rating=request.form['rating'], er="Doesn't have enough ratings to recommend!")
